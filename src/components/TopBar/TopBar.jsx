...
function TopBar() {
  ...
  return (
    <div className="absolute inset-x-0 top-0 z-10 flex h-[26px] select-none items-center justify-end border-b border-white/[0.15] bg-white/[0.18] px-3.5 text-white backdrop-blur-[20px] backdrop-saturate-[1.8]">
